...
variable "master_manager_ip_address" {default = "192.168.8.150"} ### This must be the address you initilized the Swarm from 
...
variable "manager_join_token" {default = "Example-Manager-Join-Token"}
...
variable "worker_join_token" {default = "Example-Worker-Join-Token"}
...
variable "domain" {default = "bennetdocktest.com"} # Domain 
...
variable "ssh-user" {default = "SSH-User"}
