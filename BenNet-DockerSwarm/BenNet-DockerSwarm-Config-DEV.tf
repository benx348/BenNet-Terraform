...
#### This step git clones the repo containing the docker compose files that are subseqitly deployed via a stack deploy command for each type of stack
    provisioner "remote-exec" {
      inline = [
        "git clone --branch DEV https://github.com/example-git-repo.git"
        ,"docker stack deploy --compose-file=/home/administrator/BenNet-DockSwarm-StackDeploy/Portainer-Stack-DEV.yml Portainer-Stack-DEV"
        ,"docker stack deploy --compose-file=/home/administrator/BenNet-DockSwarm-StackDeploy/Tor-Stack-DEV.yml Tor-Stack-DEV"
        ,"docker stack deploy --compose-file=/home/administrator/BenNet-DockSwarm-StackDeploy/Guac-Stack-DEV.yml Guac-Stack-DEV"
        ,"docker stack deploy --compose-file=/home/administrator/BenNet-DockSwarm-StackDeploy/Unifi-Stack-DEV.yml Unifi-Stack-DEV"
        ,"docker stack deploy --compose-file=/home/administrator/BenNet-DockSwarm-StackDeploy/Plex-Stack-DEV.yml Plex-Stack-DEV"
      ]
    }
